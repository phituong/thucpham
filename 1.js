...
window.toggleNodeMenu = function(nodeId) {
  ...
  dropdown.innerHTML = `
    <div class="node-dropdown-item" onclick="window.showConnectionAnalysis(${nodeId}); this.closest('.node-dropdown').remove();">
    ...
    <div class="node-dropdown-item" onclick="window.showBatteryAnalysis(${nodeId}); this.closest('.node-dropdown').remove();">
      <span style="font-size: 20px; width: 32px; text-align: center;">🔋</span>
